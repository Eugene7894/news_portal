...
представления-вьюсета для постов-новостей и постов-статей с возможностью использовать параметр user_id в запросе, напр.,
http://127.0.0.1:8000/api/v1/articles/?user_id=1 .
...
???OpenAPI+Swagger
Добавление пользователя через админку запрет
https://ru.stackoverflow.com/questions/1164676/%D0%9A%D0%B0%D0%BA%D0%B8%D0%BC-%D1%81%D0[…]0%BE-%D1%81%D1%82%D0%B0%D1%82%D1%8C%D0%B8-django-models-py
Получение и сохранение текущего пользователя на уровне админки
